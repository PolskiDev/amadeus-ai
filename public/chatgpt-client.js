var OPENAI_API_KEY = "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";
...
function Send() {
    ...
    if (sQuestion == "") {
        window.document.getElementById('txtOutput')
            .innerHTML = "<b>Internal Error:</b> Write or speech a question!"
        return;
    }
    txtOutput.innerHTML = "<b>Loading...</b>"
    ...
    oHttp.onreadystatechange = function () {
        if (oHttp.readyState === 4) {
            ...
            if (oJson.error && oJson.error.message) {
                ...
                if (s == "") s = "No response";
                txtOutput.innerHTML = "<b>Amadeus:</b> " + s + '\n\n';
                TextToSpeech(s);
            }            
        }
    };
...
function ClearOutputBox() {
    window.document.getElementById('txtOutput').innerHTML = ""
}